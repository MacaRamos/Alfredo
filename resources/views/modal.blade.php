        ...
        <div class="modal-body">
          ...
          <div class="row pt-4">
            ...
            <div class="col-lg-6" id="nuevoCliente" style="display: none;">
              ...
              <input type="text" class="form-control" name="cliente" id="cliente" value="" style="text-transform: uppercase;" />
              <div class="row pt-4">
                <div class="col-lg-6">
                <label class="label requerido">Celular</label>
                <input type="text" class="form-control" name="celular" id="celular" value="" placeholder="9-9999999" style="width: 10em;"/>
                </div>
                <div class="col-lg-6">
                <label class="label">Teléfono Fijo</label>
                <input type="text" class="form-control" name="fijo" id="fijo" value="" placeholder="41-9999999" style="width: 10em;"/>
              </div>
              </div>
            </div>
            <div class="col-lg-6">
              <label class="label mb-0">¿Cliente Nuevo?</label>
              <div><input class="switch bs-switch" type="checkbox" id="cliente-checkbox" name="cliente-checkbox" data-bootstrap-switch
                  data-on-color="black" data-on-text="Sí" data-off-text="No">
              </div>
            </div>
          </div>
          <div class="row pt-4">
