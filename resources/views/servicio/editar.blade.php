...
<h1 style="font-family: 'Khand', sans-serif;">Editar Servicio</h1>
@endsection
            ...
            <div class="card-header border-bottom-3 border-black">
                ...
                <div class="card-tools pull-right">
                    <a href="{{route('servicio')}}" class="btn btn-block bg-black btn-sm ">
                        <i class="fas fa-reply"></i> Volver a servcios
                    </a>
                </div>
            </div>
            <!-- form start -->
            <form action="{{route('actualizar_servicio', ['Art_cod' => trim($servicio->Art_cod)])}}" id="form-general"
